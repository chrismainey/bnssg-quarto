...
The template can be installed using the below command in the Terminal tab in RStudio. A quirk is that you often can't copy and paste with Ctrl+V into a terminal, you have to right click and press paste, then Enter.
...
7. Go to the location of your new folder, open `MyQuartoTest.qmd` in R and that's your template ready to go! You might need to run `install.packages` first on a few packages if they've not been installed before.
